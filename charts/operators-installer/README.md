...
| operators[].installPlanApproverSearchRetries | `10`          | No        | Number of times to try to find the InstallPlan. This may need to be increased for unpredictable reasons because some clusters taking longer to create InstallPlans.
| operators[].installPlanApproverSearchDelaySeconds | `5`      | No        | Total amount of time waiting before retrying to find the InstallPlan. This may need to be increased if an InstallPlan takes a while before it gets created.
